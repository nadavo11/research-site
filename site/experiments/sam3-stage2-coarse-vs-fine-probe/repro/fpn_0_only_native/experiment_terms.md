...
- Alignment reference level: `fpn_0` with aligned grid `(288, 288)`.
...
- Aligned level shape `fpn_0`: `(256, 288, 288)`.
...
- Feature materialization mode for this run: `streamed_reprepare`.
...
- Feature materialization mode: `streamed_reprepare`.
