...
- Variant summary: Learn one global softmax scale gate using only the coarsest level and the next finer level.
...
- Selected levels for the active variant: `fpn_2`, `fpn_1`.
...
- Aligned level shape `fpn_1`: `(256, 72, 72)`.
...
- Variant policy: `coarse_plus_next_finer`.
