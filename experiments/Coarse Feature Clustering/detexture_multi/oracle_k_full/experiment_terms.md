...
- Executed variant: `feature_cluster_coarse_global_pooled_oracle_k`
- Variant summary: Oracle-K prompt-free pooled coarsest clustering on frozen SAM features. GT supplies only the region count K; the clustering itself uses no prompts or GT geometry.
- Model: `facebook/sam3`
- Device request: `cuda`
