...
- Split: `test`
- Requested variant setting: `feature_cluster_coarse_to_fine_global_pooled_init_coarse_only`
- Executed variant(s): `feature_cluster_coarse_to_fine_global_pooled_init_coarse_only`
- Model: `facebook/sam3`
- Device request: `auto`
- Save visuals: `True`
- Limit: `None`
