...
- Route: `caid`
- Dataset id: `architexture:caid`
- Requested benchmark root: `datasets/architexture/caid_test`
- Expected local root form: `<root>/benchmarks/caid_test` or the experiment root containing it
